...
import {DynamicBreadcrumb} from "@/components/blocks/breadcrumb-bar";
        ...
        >
            <div className="container flex py-3 sm:py-6 gap-2">
                ...
                <Sheet open={open} onOpenChange={setOpen}>
                    <SheetTrigger asChild className="lg:hidden mt-2">
                    ...
                    <SheetContent
                        side="left"
                        className="lg:hidden flex flex-col gap-6 py-3 px-3"
                    >
            ...
            {!isHomePage && (
                <div className={`container ${isWithinHeroSection ? "text-white" : ""}`}>
                    <DynamicBreadcrumb />
                </div>
            )}
        </header>
