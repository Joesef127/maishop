...
const BrowseStyle = () => {
    return (
        <section className="flex items-center justify-center px-6 sm:px-10 lg:px-16 max-w-384 mx-auto">
            <div className="container items-center justify-center py-8 md:py-16 px-6 lg:px-12! xl:px-16! bg-layout rounded-4xl lg:rounded-[40px]">
                ...
                <div className="grid gap-2.5 sm:gap-5">
                    <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-3 lg:gap-4">
                        <Link href="/shop#casual" className="zoom-card w-full h-48 sm:h-80 cursor-pointer relative">
                        ...
                        <Link href="/shop#formal" className="zoom-card md:col-span-2 w-full h-48 sm:h-80 cursor-pointer relative">
                        ...
                        <Link href="/shop#party" className="zoom-card md:col-span-2 w-full h-48 sm:h-80 cursor-pointer relative">
                        ...
                        <Link href="/shop#gym" className="zoom-card w-full h-48 sm:h-80 cursor-pointer relative">
